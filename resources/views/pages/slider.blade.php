    ...
    <div id="banner-main" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
        <ul>
            ...
            <li data-index="rs-03" data-transition="fade" data-slotamount="default" data-easein="Power3.easeInOut"
                ...
                <!-- MAIN IMAGE -->
                <img src="{{asset('img/2.istanbul-gece-gorseli.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover"
                ...
                <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
                     ...
                     style="z-index: 5; white-space: nowrap; font-size: 18px; line-height: 22px; font-weight: 500; color: #eaeaef;font-family: 'Roboto', sans-serif;"></div>
                ...
                <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
                     ...
                     style="z-index: 7; white-space: nowrap; font-size: 23px; line-height: 30px;letter-spacing:1px;text-align: center; font-weight: bolder; color: #ffffff; font-family: 'Roboto', sans-serif;">
                    {{__('page.istanbul.content')}}
                </div>
                ...
                <div class="tp-caption rev-btn  rs-parallaxlevel-2"
                    ...
                    {{--
                    <a class="btn yellow-and-white-slider-btn" href="{{url('/blog/pegasus')}}">{{__('page.read.more')}}</a>
                    --}}
                </div>
            </li>
            ...
            <li data-index="rs-01" data-transition="fade" data-slotamount="default" data-easein="Power3.easeInOut"
                ...
                <div class="tp-caption rev-btn  rs-parallaxlevel-2"
                     ...
                     style="z-index: 11; max-width:960px; white-space: nowrap; font-size: 14px; line-height: 22px;letter-spacing: 3px; font-weight: 500; color: #ffffff; font-family:'Roboto',sans-serif;">
                    {{--
                    <a class="btn yellow-and-white-slider-btn" data-fancybox="" href="https://vimeo.com/366464900">{{__('page.read.more')}}</a>
                    --}}
                </div>
            </li>
